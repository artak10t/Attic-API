...
CREATE DATABASE IF NOT EXISTS `attic` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
USE `attic`;
...
-- Dumping data for table attic_db.accounts: ~2 rows (approximately)
...
INSERT INTO `accounts` (`account_id`, `name`, `email`, `password_bin`, `enabled`, `activated`, `access`, `privileges`, `max_space`, `current_space`, `max_attics_count`, `current_attics_count`, `max_folders_count`, `current_folders_count`, `max_files_count`, `current_files_count`, `created`, `last_login`, `delete_on`, `contact_email`, `contact_phone`, `description`) VALUES
	(1, 'Default Admin', 'admin@attic.com', _binary 0xa1301f20a5abec76e72b330301f73d55352d20ac779aecb7e961e3b6c72bc297, 1, 1, 0, 0, 10737418240, 0, 10, 0, 1000, 0, 1000000, 0, '2021-09-12 03:46:15', NULL, NULL, '', '', '');
...
-- Dumping data for table attic_db.attics: ~3 rows (approximately)
DELETE FROM `attics`;
...
-- Dumping data for table attic_db.folders: ~2 rows (approximately)
DELETE FROM `folders`;
...
-- Dumping data for table attic_db.logs: ~92 rows (approximately)
DELETE FROM `logs`;
...
-- Dumping data for table attic_db.sessions: ~8 rows (approximately)
...
-- Dumping data for table attic_db.tokens: ~16 rows (approximately)
DELETE FROM `tokens`;
